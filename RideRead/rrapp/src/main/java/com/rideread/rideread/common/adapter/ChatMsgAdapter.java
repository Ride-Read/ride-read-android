...
import com.rideread.rideread.common.adapter.ViewHolder.AVCommonViewHolder;
import com.rideread.rideread.common.adapter.ViewHolder.LeftMsgHolder;
import com.rideread.rideread.common.adapter.ViewHolder.RightMsgHolder;
...
public class ChatMsgAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public RecyclerView.ViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        if (viewType == ITEM_LEFT_TEXT) {
            return new LeftMsgHolder(parent.getContext(), parent);
        } else if (viewType == ITEM_RIGHT_TEXT) {
            return new RightMsgHolder(parent.getContext(), parent);
        } else {
            //TODO
            return null;
        }
    ...
    public void onBindViewHolder(RecyclerView.ViewHolder holder, int position) {
        ...
        if (holder instanceof LeftMsgHolder) {
            ((LeftMsgHolder) holder).showTimeView(shouldShowTime(position));
            ((LeftMsgHolder) holder).setFaceUrl(mOtherFaceUrl);
        } else if (holder instanceof RightMsgHolder) {
            ((RightMsgHolder) holder).showTimeView(shouldShowTime(position));
            ((RightMsgHolder) holder).setFaceUrl(mMyFaceUrl);
        }
    }
    ...
    public void setMyFaceUrl(String myFaceUrl) {
        mMyFaceUrl = myFaceUrl;
    }

    public void setOtherFaceUrl(String otherFaceUrl) {
        mOtherFaceUrl = otherFaceUrl;
    }
}