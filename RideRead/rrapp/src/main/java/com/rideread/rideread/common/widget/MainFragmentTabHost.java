...
/**
 * 自定义FragmentTabHost，把创建的fragment保存，避免重复创建fragment
 * Created by Jackbing on 2016/12/25.
 */
...
public class MainFragmentTabHost extends TabHost implements TabHost.OnTabChangeListener {
    ...
    static class SavedState extends BaseSavedState {
        ...
        public String toString() {
            return "MyFragmentTabHost.SavedState{" + Integer.toHexString(System.identityHashCode(this)) + " curTab=" + curTab + "}";
        }
        ...
        if (mLastTab != newTab) {
            ...
            if (newTab != null) {
                if (newTab.fragment == null) {
                    ...
                    ft.show(newTab.fragment);//把隐藏的fragment显示
                }
            }
